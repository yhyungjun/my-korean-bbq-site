...
export const CONTENT = {
  ...
  gamasot: {
    ko: `      <strong>가마솥의 유래와 특징</strong><br><br>
      가마솥은 삼국시대 이전, 그러니까 2,000년쯤 전부터 써 온 것으로 알려져 있어요.
      무쇠로 만든 가마솥이 서민들 집까지 퍼진 건 삼국시대 후기, 약 1,400년 전부터고요.<br><br>
      무쇠는 열이 천천히 오르는 대신 한번 달궈지면 쉽게 식지 않아요.
      그래서 열이 고르게 퍼져 고기가 속까지 맛있게 익어요.<br><br>
      가마솥은 한국의 전통 조리 도구이자, 가족과 공동체의 정을 담아 온 소중한 살림살이예요.
    `,
  ...
  ssam: {
    ko: `      <strong>쌈이란?</strong><br>
      정해진 방법은 없어요. 내 입맛대로 싸서 먹는 게 정답이에요.<br><br>
      채소 위에 참기름이나 콩가루를 살짝 찍은 고기를 올리고, 쌈장을 얹어 한입에 드셔 보세요.<br>
      같은 방법으로 고기에 여러 소스를 찍어 올리고,
      취향에 맞게 파절이, 김치, 구운 마늘, 콩나물을 곁들이면 더 맛있어요.<br><br>
      고기 본연의 맛을 느끼고 싶다면, 소금만 살짝 찍어 드시는 걸 추천해요.
    `,
