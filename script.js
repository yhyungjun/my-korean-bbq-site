...
function showMenuDetail(menu) {
  ...
  if (menu === "A") {
    content = `
      ...
      <p data-lang="ja" style="display:none;"><span class="menu-subtitle"><strong class="course-label">A</strong> 豚盛り合わせ 無限リフィル</span>1人 <span class="price">17,900ウォン</span><br>サムギョプサル + 豚肩ロース + 牛バラ肉 + 豚トロ + ハラミ + 薄切りサムギョプサル + 豚皮（ハチの巣）+ 豚プルコギ + 牛ホルモン + 野菜サム</p>
      ...
      <p data-lang="es" style="display:none;"><span class="menu-subtitle"><strong class="course-label">A</strong> Surtido de Cerdo Ilimitado</span>pan class="price">₩17.900</span> por pessoa<br>Barriga + Pescoço + Peito bovino + Bochecha + Fraldinha + Panceta fina + Pele em favo + Bulgogi de porco + Intestino bovino + Vegetais</p>
      ...
      <p data-lang="ru" style="display:none;"><span class="menu-subtitle"><strong class="course-label">A</strong> Ассорти из свинины безлимит</span><span class="price">17,900₩</span> за чел<br>Самгёпсаль + Шея + Грудинка + Щёки + Диафрагма + Тонкий самгёпсаль + Свиная кожа + Булгоги + Кишки + Овощи</p>
      <p data-lang="tr" style="display:none;"><span class="menu-subtitle"><strong class="course-label">A</strong> Domuz Karışık Sınırsız</span>Kişi <span class="price">₩17.900</span> <br>Domuz göbeği + Boyun + Dana göğüs + Yanak + Diyafram + İnce göbek + Domuz derisi + Bulgogi + Bağırsak + Sebzeler</p>
    `;
  }
