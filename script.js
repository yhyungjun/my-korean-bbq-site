...
function showMenuDetail(menu) {
  ...
  if (menu === "A") {
    content = header + `
      <p data-lang="ko"><span class="menu-subtitle"><strong class="course-label">A</strong> 돼지모듬 무한리필</span>1인 <span class="price">17,900원</span><br>삼겹살<span class="unlimited">+</span>목살<span class="unlimited">+</span>우삼겹<span class="unlimited">+</span>가브리살<span class="unlimited">+</span>갈매기살<span class="unlimited">+</span>대패삼겹살<span class="unlimited">+</span>벌집껍데기<span class="unlimited">+</span>돼지불고기<span class="unlimited">+</span>소대창<span class="unlimited">+</span>모듬야채쌈</p>
      <p data-lang="en" style="display:none;"><span class="menu-subtitle"><strong class="course-label">A</strong> Pork Assortment Unlimited Refill</span><span class="price">₩17,900</span> per person<br>Pork belly <span class="unlimited">+</span> Pork neck <span class="unlimited">+</span> Beef brisket <span class="unlimited">+</span> Pork jowl <span class="unlimited">+</span> Skirt meat <span class="unlimited">+</span> Thin-sliced pork belly <span class="unlimited">+</span> Honeycomb pork skin <span class="unlimited">+</span> Pork bulgogi <span class="unlimited">+</span> Beef intestine <span class="unlimited">+</span> Assorted vegetable wraps</p>
      <p data-lang="zh" style="display:none;"><span class="menu-subtitle"><strong class="course-label">A</strong> 猪肉拼盘 无限续</span>每人 <span class="price">17,900韩元</span><br>五花肉 <span class="unlimited">+</span> 猪颈肉 <span class="unlimited">+</span> 牛胸肉 <span class="unlimited">+</span> 猪颊肉 <span class="unlimited">+</span> 横膈膜肉 <span class="unlimited">+</span> 薄切五花肉 <span class="unlimited">+</span> 蜂窝猪皮 <span class="unlimited">+</span> 猪肉烤肉 <span class="unlimited">+</span> 牛大肠 <span class="unlimited">+</span> 蔬菜包</p>
      <p data-lang="ja" style="display:none;"><span class="menu-subtitle"><strong class="course-label">A</strong> 豚盛り合わせ 無限リフィル</span>1人 <span class="price">17,900ウォン</span><br>サムギョプサル <span class="unlimited">+</span> 豚肩ロース <span class="unlimited">+</span> 牛バラ肉 <span class="unlimited">+</span> 豚トロ +</span> ハラミ <span class="unlimited">+</span> 薄切りサムギョプサル <span class="unlimited">+</span> 豚皮（ハチの巣）<span class="unlimited">+</span> 豚プルコギ <span class="unlimited">+</span> 牛ホルモン <span class="unlimited">+</span> 野菜サム</p>
      <p data-lang="vi" style="display:none;"><span class="menu-subtitle"><strong class="course-label">A</strong> Suất Buffet Thịt Heo Không Giới Hạn</span><br><span class="price">17,900 KRW</span>/người<br>Ba chỉ <span class="unlimited">+</span> Thịt cổ <span class="unlimited">+</span> Ức bò <span class="unlimited">+</span> Má heo <span class="unlimited">+</span> Thăn sườn <span class="unlimited">+</span> Ba chỉ thái mỏng <span class="unlimited">+</span> Da heo tổ ong <span class="unlimited">+</span> Bulgogi heo <span class="unlimited">+</span> Lòng bò <span class="unlimited">+</span> Rau cuốn</p>
      <p data-lang="th" style="display:none;"><span class="menu-subtitle"><strong class="course-label">A</strong> เซ็ตหมูรวมเติมไม่อั้น</span>คนละ <span class="price">17,900 วอน</span><br>หมูสามชั้น <span class="unlimited">+</span> คอหมู <span class="unlimited">+</span> เนื้ออกวัว <span class="unlimited">+</span> คอหมูอบ <span class="unlimited">+</span> สันในหมู <span class="unlimited">+</span> หมูสไลซ์บาง <span class="unlimited">+</span> หนังหมู <span class="unlimited">+</span> หมูบูลโกกิ <span class="unlimited">+</span> ไส้วัว <span class="unlimited">+</span> ผักห่อ</p>
      <p data-lang="ph" style="display:none;"><span class="menu-subtitle"><strong class="course-label">A</strong> Unlimited Pork Set</span><span class="price">₩17,900</span> bawat tao<br>Pork belly <span class="unlimited">+</span> Pork neck <span class="unlimited">+</span> Beef brisket <span class="unlimited">+</span> Pork jowl <span class="unlimited">+</span> Skirt meat <span class="unlimited">+</span> Thin-sliced pork <span class="unlimited">+</span> Pork skin <span class="unlimited">+</span> Pork bulgogi <span class="unlimited">+</span> Beef intestine <span class="unlimited">+</span> Mixed vegetable wraps</p>
      <p data-lang="fr" style="display:none;"><span class="menu-subtitle"><strong class="course-label">A</strong> Assortiment de Porc à volonté</span><span class="price">17 900₩</span> par personne<br>Poitrine <span class="unlimited">+</span> Échine <span class="unlimited">+</span> Poitrine de bœuf <span class="unlimited">+</span> Joue de porc <span class="unlimited">+</span> Hampe <span class="unlimited">+</span> Poitrine fine <span class="unlimited">+</span> Couenne en nid d’abeille <span class="unlimited">+</span> Bulgogi de porc <span class="unlimited">+</span> Tripes de bœuf <span class="unlimited">+</span> Légumes</p>
      <p data-lang="es" style="display:none;"><span class="menu-subtitle"><strong class="course-label">A</strong> Surtido de Cerdo Ilimitado</span><span class="price">₩17.900</span> por pessoa<br>Barriga <span class="unlimited">+</span> Pescoço <span class="unlimited">+</span> Peito bovino <span class="unlimited">+</span> Bochecha <span class="unlimited">+</span> Fraldinha <span class="unlimited">+</span> Panceta fina <span class="unlimited">+</span> Pele em favo <span class="unlimited">+</span> Bulgogi de porco <span class="unlimited">+</span> Intestino bovino <span class="unlimited">+</span> Vegetais</p>
      ...
      <p data-lang="ru" style="display:none;"><span class="menu-subtitle"><strong class="course-label">A</strong> Ассорти из свинины безлимит</span><span class="price">17,900₩</span> за чел<br>Самгёпсаль <span class="unlimited">+</span> Шея <span class="unlimited">+</span> Грудинка <span class="unlimited">+</span> Щёки <span class="unlimited">+</span> Диафрагма <span class="unlimited">+</span> Тонкий самгёпсаль <span class="unlimited">+</span> Свиная кожа <span class="unlimited">+</span> Булгоги <span class="unlimited">+</span> Кишки <span class="unlimited">+</span> Овощи</p>
      <p data-lang="tr" style="display:none;"><span class="menu-subtitle"><strong class="course-label">A</strong> Domuz Karışık Sınırsız</span>Kişi <span class="price">₩17.900</span> <br>Domuz göbeği <span class="unlimited">+</span> Boyun <span class="unlimited">+</span> Dana göğüs <span class="unlimited">+</span> Yanak <span class="unlimited">+</span> Diyafram <span class="unlimited">+</span> İnce göbek <span class="unlimited">+</span> Domuz derisi <span class="unlimited">+</span> Bulgogi <span class="unlimited">+</span> Bağırsak <span class="unlimited">+</span> Sebzeler</p>
    `;
  }
  ...
  // ✅ B코스
    ...
    content = header + `
      ...
      <p data-lang="ja" style="display:none;"><span class="menu-subtitle"><strong class="course-label">B</strong> 豚盛り合わせ+醤油チキン 無限リフィル</span>1人 <span class="price">19,900ウォン</span><br>サムギョプサル+醤油チキン+肩ロース+牛バラ+豚トロ+ハラミ+薄切り+皮+プルコギ+ホルモン+野菜</p>
      <p data-lang="vi" style="display:none;"><span class="menu-subtitle"><strong class="course-label">B</strong> Suất Thịt Heo + Gà Xì Dầu Không Giới Hạn</span><span class="price">19,900 KRW</span>/người<br>Ba chỉ + Gà xì dầu + Cổ + Ức bò + Má + Thăn + Ba chỉ mỏng + Da + Bulgogi + Lòng + Rau</p>
      <p data-lang="th" style="display:none;"><span class="menu-subtitle"><strong class="course-label">B</strong> หมูรวม + ไก่ซอสถั่วเหลือง เติมไม่อั้น</span>คนละ <span class="price">19,900 วอน</span><br>หมูสามชั้น + ไก่ซอสถั่วเหลือง + คอหมู + เนื้อวัว + สันในหมู + หมูสไลซ์บาง + หนังหมู + หมูบูลโกกิ + ไส้วัว + ผักห่อ</p>
      <p data-lang="ph" style="display:none;"><span class="menu-subtitle"><strong class="course-label">B</strong> Unlimited Pork + Soy Chicken Set</span><span class="price">₩19,900</span> bawat tao<br>Pork belly + Soy-marinated chicken + Pork neck + Beef brisket + Pork jowl + Skirt meat + Thin pork belly + Pork skin + Pork bulgogi + Beef intestine + Veggie wraps</p>
      <p data-lang="fr" style="display:none;"><span class="menu-subtitle"><strong class="course-label">B</strong> Porc + Poulet soja à volonté</span><span class="price">19 900₩</span> par personne<br>Poitrine + Poulet soja + Échine + Poitrine bœuf + Joue + Hampe + Fine poitrine + Peau + Bulgogi + Tripes + Légumes</p>
      <p data-lang="es" style="display:none;"><span class="menu-subtitle"><strong class="course-label">B</strong> Cerdo + Pollo soja Ilimitado</span><span class="price">19,900₩</span> por persona<br>Panceta + Pollo soja + Cuello + Falda + Papada + Entraña + Panceta fina + Piel + Bulgogi + Intestino + Verduras</p>
      <p data-lang="pt" style="display:none;"><span class="menu-subtitle"><strong class="course-label">B</strong> Porco + Frango molho soja Rodízio</span><span class="price">₩19.900</span> por pessoa<br>Barriga + Frango soja + Pescoço + Peito boi + Bochecha + Fraldinha + Panceta fina + Pele + Bulgogi + Intestino + Vegetais</p>
      <p data-lang="ar" style="display:none;"><span class="menu-subtitle"><strong class="course-label">B</strong> خنزير+دجاج صويا مفتوح</span><span class="price">19,900₩</span> للشخص<br>بطن + دجاج صويا + رقبة + صدر بقر + خدود + لحم الحجاب + بطن رفيع + جلد + بولغوغي + أمعاء + خضار</p>
      <p data-lang="ru" style="display:none;"><span class="menu-subtitle"><strong class="course-label">B</strong> Свинина+Соевый курица безлимит</span><span class="price">19,900₩</span> чел<br>Самгёпсаль + Курица соя + Шея + Грудинка + Щёки + Диафрагма + Тонкий самгёпсаль + Кожа + Булгоги + Кишки + Овощи</p>
      <p data-lang="tr" style="display:none;"><span class="menu-subtitle"><strong class="course-label">B</strong> Domuz+Soya Tavuk Sınırsız</span><span class="price">₩19.900</span> kişi<br>Göbek + Soya tavuk + Boyun + Dana göğüs + Yanak + Diyafram + İnce göbek + Deri + Bulgogi + Bağırsak + Sebze</p>
    `;
  }
  ...
  // ✅ F코스
    ...
    content = header + `
      ...
      <p data-lang="pt" style="display:none;"><span class="menu-subtitle">Curso <strong class="course-label">Completo</strong> Rodízio</span><span class="price">₩23.900</span> por pessoa<br>Barriga de porco + frango ao molho de soja + pescoço + peito + bochecha + fraldinha + pele em favo + bulgogi + tripas + legumes + bebidas <span class="unlimited">ilimitados</span>+ arroz <span class="unlimited">ilimitados</span> + macarrão frio <span class="unlimited">ilimitados</span></p>
      ...
      <p data-lang="tr" style="display:none;"><span class="menu-subtitle"><strong class="course-label">Tam</strong> Kurs Sınırsız</span>Kişi başı <span class="price">₩23.900</span><br>Domuz eti + soya soslu tavuk + boyun + dana göğüs + yanak + diyafram + ince dilimlenmiş domuz eti + deri + bulgogi + bağırsak + sebze + İçecekler <span class="unlimited">sınırsız</span> + Pilav <span class="unlimited">sınırsız</span> + Soğuk erişte <span class="unlimited">sınırsız</span></p>
    `;
  }
