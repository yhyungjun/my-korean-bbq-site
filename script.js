...
function showMenuDetail(menu) {
  ...
  if (menu === "A") {
    content = header + `
      ...
      <p data-lang="ru" style="display:none;"><span class="menu-subtitle"><strong class="course-label">A</strong> Ассорти из свинины безлимит</span><span class="price">17,900₩</span> за чел<br>Самгёпсаль <span class="unlimited">+</span> Шея <span class="unlimited">+</span> Грудинка <span class="unlimited">+</span> Щёки <span class="unlimited">+</span> Диафрагма <span class="unlimited">+</span> Тонкий самгёпсаль <span class="unlimited">+</span> Свиная кожа <span class="unlimited">+</span> Булгоги <span class="unlimited">+</span> Кишки <span class="unlimited">+ Овощи</p>
